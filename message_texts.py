...
MESSAGES = {
    ...
    'feedback_confirm': (
        'Отлично, осталось последнее действие. Ты знаешь, что делать😎\n'
    ...
    'notify_request_date': (
        'Выбери дату и я сразу напомню, когда рейсы будут доступны для заказа.',
    ),
    'notify_notification': (
        '🔔 *Появились рейсы!* \n📆 %s\nНе забудь заказать!',
    ),
...
# TODO: parse_input_route не должен быть равен track_input_route
