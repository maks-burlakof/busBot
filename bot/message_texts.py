...
MESSAGES = {
    ...
    'extra_admin': (
        '👨‍👩‍👦‍👦 <b>Пользователи:</b>\n'
        '/db [-full, -f] - Содержимое БД\n'
        '/users - Список юзеров\n'
        '/ban - Забанить юзера\n'
        '🔔 /announcement - Объявление\n'
        '📃 /logs [-clear] - Отправить файл логов\n'
    ...
    'notify_delete_success': (
        '❌ Перестал отслеживать эту дату.',
        '❌ Теперь я не отслеживаю эту дату.',
    ),
    'notify_exist': (
    ...
    'track_delete_success': (
        ...
        '❌ Я не отслеживаю эту маршрутку.',
        '❌ Убрал эту маршрутку.',
        '❌ Отменил эту маршрутку.',
        '❌ Забыли про эту маршрутку.',
        '❌ Удалено.',
    ),
    'track_other_people': (
